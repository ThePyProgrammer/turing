...
description: "The ideas, principles, and prior work that Turing builds on — from Polányi's tacit knowledge to Goodhart's Law, from Karpathy's autoresearch to Hassabis's Nobel insight."
---
...
Normal science (puzzle-solving within a paradigm) is the most automatable part of research. Paradigm selection — choosing the framework, recognizing when it's exhausted — is explicitly non-algorithmic.
